...
def get_face_service_status():
    """
    取得 AI 人臉辨識服務與目前快取狀態。

    載入數量以不重複的 member_id / visitor_id 計算，
    避免同一個人有多張人臉照片時被重複計數。
    """

    ai_operational = _get_face_recognition() is not None
    ...
    return {
        ...
        "loaded_member_count": len(loaded_member_ids),
        "loaded_visitor_count": len(loaded_visitor_ids),
    }
